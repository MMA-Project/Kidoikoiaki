...
import { useList, useCreateParticipant, useDeleteParticipant, useDeleteExpense, useBalances } from '../api/hooks';
      ...
      >
        ...
        <div className="flex flex-wrap gap-2">
          {list.participants.length === 0 ? (
            <p className="text-slate-400 italic">Aucun participant. Ajoutez-en un pour commencer !</p>
          ) : (
            <AnimatePresence>
          ...
          >
            ...
            <div className="space-y-4">
              {list.expenses.length === 0 ? (
                <p className="text-slate-400 italic">Aucune dépense pour le moment.</p>
              ) : (
                <AnimatePresence>
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          ...
                          <p className="text-slate-500 text-sm">
                            Payé par <span className="font-medium text-indigo-600">{expense.payerName}</span>
                          </p>
                          <p className="text-slate-400 text-sm">
                            Pour: {expense.participants.map(p => p.name).join(', ')}
                          </p>
