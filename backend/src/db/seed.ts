...
async function seed() {
  ...
  try {
    ...
    await new sql.Request(transaction)
      ...
      .query(`INSERT INTO Lists (id, name, description) VALUES (@id, @name, @description)`);
    ...
    await new sql.Request(transaction)
      ...
      .input('name', 'Alice')
      .query(`INSERT INTO Participants (id, listId, name) VALUES (@id, @listId, @name)`);
    ...
    await new sql.Request(transaction)
      ...
      .query(`INSERT INTO ExpenseParticipants (expenseId, participantId) VALUES (@expenseId, @participantId)`);
    await new sql.Request(transaction)
      .input('expenseId', expense1Id)
